...
const CallToAction = () => {
  return (
    <div data-aos="fade-up" className="bg-white max-sm:hidden max-w-[calc(100vw-2rem)] md:max-w-[1260px] rounded-[20px] p-4 absolute top-[2790px] left-4 md:left-[400px] z-10">
